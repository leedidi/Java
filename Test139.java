...
public class Test139
{
	public static void main(String[] args) throws IOException
	{
		...
		//-- 날짜....!!
		//-- d에 캘린더클래스에 저장된 그달의 마지막 날짜를 구할수 있는 방법,,?
		//   >> 월을 입력하면 d가 그달의 마지막 날짜로 입력될수 있는 방법?
		//   >> 다음달1일 -1...???? ??
...
public class Test139
{
	...
	{	
		...
		int y, m;		//-- 년, 월
		int w;			//-- 요일
		int i;			//-- 달력을 그리는 과정에서 사용하게 될 루프 변수(@ 반복문 공유위해 위에 정의)
...
//@ 그레고리력은 1년부터 계산할수 X! 특정 년도 이후부터 가능
//@ 배운 내용은 복습해보기! API 도큐먼트도 복습...
//@ 복습방법 못찾겠다 싶으면 하얀 메모장 띄워서 오늘 배운거 다 다 쳐보기! 그거도 좋은 복습 방법임!