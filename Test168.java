...
public class Test168
{
	public static void main(String[] args) throws IOException
	{
		...
		while ( (data = System.in.read()) != -1) //@ 바이트 스트림으로 읽어서 데이터에 담김. //@ 입력값이 -1이 아니라면,
		{
			ch = (char)data;
			
			//System.out.print(ch);	//@ 데이터로 형변환해서 출력.
			//--==>> 
			/*
			문자열 입력(종료:Ctrl+z)
			abcd
			...
			계속하려면 아무 키나 누르십시오 . . .
			*/
			//@@ 바이트기반으로 읽어서 문자기반으로 내보내려고 하니까 영어,숫자는 되는데 한글은 깨짐..
			...
			계속하려면 아무 키나 누르십시오 . . .
			*/
			//@@ 바이트기반으로 읽어서 바이트기반으로 내보내려고 하니까 영어,숫자,한글 다 가능
