...
/*
○ String 클래스는 내부 문자열 데이터에 대한 수정이 불가능하다. --@★ String 클래스의 가장 중요한 특징
   (즉, 내용 불변 : Immutable)
...
public class Test132
{
	public static void main(String[] args)
	{
		...
		//		 true
		//		 true
		//@ 원래 Object의 equals()는 주소값을 비교 
		//@ String 클래스가 상속받은후 오버라이딩.... 
		//  그래서 String 클래스의 equals는 문자열 데이터의 값(내용)으로 비교가능! @★ 중요!
